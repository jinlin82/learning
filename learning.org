...
** TODO Rmarkdown docx 输出模板配置（需要更新）
...
#+LATEX: \bibliographystyle{GBT7714-2005N}   % 参考文献style,中文的排序在fixbbl的选项中
# use this comment line to fool org-ref find bib file +BIBLIOGRAPHY: Gompertz.bib  
#+BIBLIOGRAPHY: Gompertz unsrt option:-nobibsource option:-i option:-nokeywords option:-noabstract limit:t    
# +BIBLIOGRAPHY: Gompertz GBT7714-2005N option:-nobibsource option:-i option:-nokeywords option:-noabstract limit:t

* Export Configuration 					   :noexport:ARCHIVE:
# +LATEX_CLASS_OPTIONS: % 版本 2019-1-14
...
#+LATEX_HEADER_EXTRA: \lineskip -0.5em%
#+LATEX_HEADER_EXTRA: \begin{tabular}[t]{c}}
#+LATEX_HEADER_EXTRA: \postauthor{\end{tabular}\par\end{center}}
#+LATEX_HEADER_EXTRA: \predate{\begin{center}\CJKfamily{kai}\vskip -1em}
...
#+LaTeX_HEADER_EXTRA: \usepackage[top=2cm,bottom=2cm,left=2.5cm,right=2.5cm]{geometry}
